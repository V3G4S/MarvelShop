...
//     link = JSON.parse(localStorage.getItem('totCompArr'))
// }
...
//     article.append(div)
//     document.getElementById('img-' + i).style.backgroundImage = 'url (img/img' + i + '.jpg'
...
//     }
//     let novoUsr = prompt("Nome de usuário: ")
//     usr.push(novoUsr)
...
//         snh = JSON.parse(localStorage.getItem('snhArr'))
//     }
//     login = prompt("Nome de usuário: ")
//     senha = prompt("Senha: ")
//     let indUsr = usr.indexOf(login)
//     if(usr[indUsr] == login && snh[indUsr] == senha){
//         document.querySelector("#login").innerHTML = `Bem-vindo(a), ${login}`
//     }else{
//         alert("Digite o usuário/senha correto")
//     }
// }
